...
import { useRef, useState, createContext, useContext, useEffect, useMemo } from "react";
import SkullRig from "./SkullRig";
    ...
    <BoneContext.Provider value={{
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          ...
          <SkullRig faceLandmarks={landmarks.faceLandmarks} />
        </Canvas>
        <HoverLabel />
      </div>
